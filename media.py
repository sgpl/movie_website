...
class Movie():
    ...
    # it is called when an instance of a movie is created.
    # it contains the inputs that the instance of the movie
    # needs to be created with such as:
    # the title, storyline, duration, poster, trailer link, year, etc.
    def __init__(self, movie_title, movie_storyline, poster_image,
                 trailer_youtube, duration, year, director):
    ...
    # this function is called to display a trailer for a movie.
    # it takes in self / itself as an argument and
