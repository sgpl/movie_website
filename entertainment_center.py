...
dark_knight = media.Movie("The Dark Knight",
                          ...
                          " film, but as a richly thrilling crime saga.",
...
angry_men = media.Movie("12 Angry Men",
                        ...
                        " one holdout (Jack Lemmon) is convinced of"
                        " the defendant's innocence and "
                        "stubbornly argues reasonable doubt.",
...
slist = media.Movie("Schindler's List",
                    ...
                    "humanism to create the director's dramatic masterpiece",
